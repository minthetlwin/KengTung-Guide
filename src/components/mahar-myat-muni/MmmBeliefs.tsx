...
export function MmmBeliefs() {
  ...
  return (
    <section id="beliefs-traditions" className="mx-auto w-full max-w-[1440px] scroll-mt-32 px-gutter md:px-gutter-lg">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
        <div
          className="sticky top-24 h-72 self-start rounded-2xl border border-border bg-cover bg-center shadow-soft lg:col-span-5 lg:h-[460px]"
          ...
          {b.items.map((item, i) => (
            ...
            >
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-primary/20 bg-primary-soft text-on-primary-soft">
                <span className="material-symbols-outlined text-[22px]">{BELIEF_ICONS[i % BELIEF_ICONS.length]}</span>
              </span>
